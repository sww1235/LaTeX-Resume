...
\setlength{\hintscolumnwidth}{3.9cm}                % if you want to change the width of the column with the dates
...
%https://tex.stackexchange.com/a/108909/73081
\makeatletter
...
\begin{itemize}
	...
	\item Performed field wireless propagation surveys to confirm chosen field locations would perform to standard.
\end{itemize}
}
...
\cvitem{March 2025}{Licensed as a Professional Engineerin in Colorado: PE.0066180}
\cvitem{May 2019}{Certified as Engineering Intern (EI) in Colorado; \newline Passed Fundamentals of Engineering exam.}
